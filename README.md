<h2 align="center">
    anime_69's lazy telegram autoposting
</h2>
<h4 align="center">
...
<p>
    - download python (supposedly 3.11 but idk, maybe with kurigram later versions work)<br>
    - download <a target="_blank" rel="noopener noreferrer" href="https://github.com/KurimuzonAkuma/kurigram">kurigram</a><br>
    - make sure that %PATH% is set up correctly. you can google how to do that<br>
