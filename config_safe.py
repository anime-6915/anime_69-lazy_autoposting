...
LINKS_DUMP_CHAT = "chat where you send links to arts goes here" # a69 bot
TWITTER_LINKS_BOT = '@uasaverbot' # link to twitter posts processing bot goes here.
PIXIV_LINKS_BOT = '@Pixiv_bot'    # link to pixiv posts processing bot goes here.
link_url = str()

SOURCE_CHANNEL_ID = 0 # intermediate variable. do not change